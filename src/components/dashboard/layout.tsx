...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-50 w-64 glass-panel bg-white/40 text-blue-950 transform transition-transform duration-200 ease-in-out lg:translate-x-0 backdrop-blur-xl border-r border-white/40",
                    isMobileOpen ? "translate-x-0" : "-translate-x-full"
                )}
            >
                <div className="flex flex-col h-full">
                    {/* Logo */}
                    <div className="flex items-center justify-center h-16 border-b border-white/40">
                                ...
                                <Link
                                    ...
                                    className={cn(
                                        ...
                                        isActive
                                            ...
                                            : "text-blue-800 hover:bg-white/60 hover:text-blue-950"
                                    )}
                                >
                    ...
                    <div className="p-4 border-t border-white/40">
                        <div className="flex items-center gap-3 px-4 py-3 bg-white/50 rounded-xl">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-bold text-blue-950 truncate">Het Patel</p>
                                <p className="text-xs text-blue-700 truncate">Admin</p>
                            </div>
                            <Button
                                variant="ghost"
                                size="icon"
                                className="text-blue-800 hover:text-blue-950 hover:bg-white/80"
                            >
...
export function Header() {
    return (
        <header className="h-16 glass-panel bg-white/60 backdrop-blur-xl border-b border-white/40 flex items-center justify-between px-6 lg:px-8 sticky top-0 z-40">
